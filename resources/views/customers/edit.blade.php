            ...
            <form action="{{ route('customers.update', $customer) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="snd-form-section-heading">
                    ...
                    <div>
                        ...
                        <p>Keep customer contact information ready for checkout and order history.</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" class="form-control @error('first_name') is-invalid @enderror"
                                   id="first_name" placeholder="{{ __('customer.First_Name') }}" value="{{ old('first_name', $customer->first_name) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="last_name" class="form-control @error('last_name') is-invalid @enderror"
                                   id="last_name" placeholder="{{ __('customer.Last_Name') }}" value="{{ old('last_name', $customer->last_name) }}">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="address" class="form-control @error('address') is-invalid @enderror"
                                   id="address" placeholder="{{ __('customer.Address') }}" value="{{ old('address', $customer->address) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            @error('avatar')<span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>@enderror
                        </div>
                    </div>
                </div>

                <div class="snd-form-actions">
                    <button class="btn btn-primary" type="submit"><x-snd-icon name="save" class="mr-1" />Update</button>
                </div>
            </form>
        </div>
    </div>
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            if (window.bsCustomFileInput) window.bsCustomFileInput.init();
        });
    </script>
@endsection
