...
<div class="card">
    <div class="card-body">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('customers.edit', $customer) }}" class="btn btn-primary"><x-snd-icon name="square-pen" /></a>
                        <button class="btn btn-danger btn-delete" data-url="{{route('customers.destroy', $customer)}}"><x-snd-icon name="trash" /></button>
                    </td>
                </tr>
                @empty
        ...
        <x-snd-pagination :paginator="$customers" />
    </div>
</div>
@endsection
